...
class template_Class
{
    ...
    <div id="mobileMenu">
        <ul>
            ...
            <li><a href="Grafiks.php">Grafiks</a></li>
            <li><a href="Kontakti.php">Kontakti</a></li>
            <li><a href="logout.php?logout">Iziet</a></li>
        </ul>
    </div>
    <h1>Esi sveicināts! </h1>
    <p>Deju akadēmijas nosaukums</p>
...
<section id="spacer">
    ...
    <div class="search">
        <form action="#">
            <input type="text" name="sitesearch" value="Rakstīt šeit..."/>
